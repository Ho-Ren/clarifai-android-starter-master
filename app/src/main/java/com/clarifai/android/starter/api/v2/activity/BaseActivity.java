...
//M4D1TZIj4VesXK9SQ1GwCw0DSP6Iv9gNnVGglnUc
...
import com.clarifai.android.starter.api.v2.Example;
import com.clarifai.android.starter.api.v2.FoodSearch;
/**
...
public abstract class BaseActivity extends AppCompatActivity implements View.OnClickListener {
  ...
  private String apiKeyUSDA = "M4D1TZIj4VesXK9SQ1GwCw0DSP6Iv9gNnVGglnUc";
...
//      startGoogleApi();
  ...
  public void requestForFoodSearch() {
    ...
    String url = "https://api.nal.usda.gov/ndb/search/?format=json&q=" + foodName + "&sort=n&max=25&offset=0&api_key=" + "6ODfp4j6hYslVcdoeVAeZ8xIwMWtEL3bzJGae3Xi";
  ...
  public void requestForFoodInfo() {
    ...
    String url ="https://api.nal.usda.gov/ndb/reports/?ndbno="+ndbno+"&type=b&format=json&api_key="+"6ODfp4j6hYslVcdoeVAeZ8xIwMWtEL3bzJGae3Xi";

    httpRequest2(url);
  }

  public void requestForFoodInfo(String ndbno) {
    ...
    StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
            new Response.Listener<String>() {
              ...
              public void onResponse(String response) {
                ...
                largeLog(TAG, "getResponse" + getResponse);

                Gson gson = new Gson();
                FoodSearch fs = gson.fromJson(getResponse, FoodSearch.class);
                ndbno = fs.getList().getItem().get(0).getNdbno();
                Log.e(TAG, fs.getList().getItem().get(0).getNdbno());
                requestForFoodInfo(ndbno);
              }
  ...
  public void httpRequest2(String url){
    RequestQueue queue = Volley.newRequestQueue(this);
    ...
    StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
            new Response.Listener<String>() {
              ...
              public void onResponse(String response) {
                ...
                Gson gson = new Gson();
                Example ex = gson.fromJson(getResponse, Example.class);
                Log.e(TAG, ex.report.type);
              }
            }, new Response.ErrorListener() {
      @Override
      public void onErrorResponse(VolleyError error) {
